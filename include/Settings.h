...
//extern char *RIG_IDENTIFIER = "Siemens OLED Case";
extern char *RIG_IDENTIFIER = "";
// Change the part in brackets to your WiFi name
extern const char SSID[] = "";
// Change the part in brackets to your WiFi password
extern const char PASSWORD[] = "";
extern const char OTA_PASSWORD[] = "sfasfasfasdfsadfasdfasdfasdfdsf";
// -------------------------------------------------------------- //
...
// ESP8266 WEB/CRASH-DIAGNOSE - Test/Master-Kandidat
// 1 = Funktion/Anzeige aktiv, 0 = entsprechender Diagnosebereich aus.
#define CRASHLOG_ENABLED        1
#define WEB_DIAG_CRASHLOG       1

// Comment out the line below if you wish to disable LED blinking
// #define LED_BLINKING  // WAthER-TV: GPIO2 ist TFT_RST, daher LED-Blinken deaktiviert
...
#if defined(ESP8266)
    // WAthER-TV: GPIO2 ist TFT_RST. Nicht als Status-LED benutzen.
    #ifdef LED_BUILTIN
      #undef LED_BUILTIN
    #endif
